...
import com.ipc2.todoweb.TransformandoObjeto.TransformarObjeto;
...
public class LecturaArchivo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       /* TransformarObjeto transformarObjeto = new TransformarObjeto();
        transformarObjeto.analizar(inputFileName);
